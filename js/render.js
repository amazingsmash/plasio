...
THREE.TrackballGeoControls = function ( object, domElement ) {
	...
	this.update = function () {
		...
		//JM Fixing camera always vertical
		_this.object.up.copy( new THREE.Vector3(0, 1, 0) ); 
...
THREE.TrackballGeoControls.prototype = Object.create( THREE.EventDispatcher.prototype );
...
(function(w) {
	...
	function init(render_container) {
		...
		getCameraControl().addCameraGeo("perspective-geo", new THREE.PerspectiveCamera(60, w/h, 1, 10000));
		...
		getCameraControl().makeActive("perspective-geo");
		...
		$(document).on("plasio.camera.perspective-geo", function() {
			getCameraControl().makeActive("perspective-geo");
		});
